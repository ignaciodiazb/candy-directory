...
class Admin::BrandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index returns success" do
    get admin_brands_path, headers: admin_headers
  ...
  test "show returns success" do
    get admin_brand_path(brands(:ambrosoli)), headers: admin_headers
    assert_response :success
  end
  ...
  test "new returns success" do
    get new_admin_brand_path, headers: admin_headers
    assert_response :success
  end
  ...
  test "create with invalid params renders new with 422" do
    assert_no_difference("Brand.count") do
      post admin_brands_path, params: { brand: { name: "" } }, headers: admin_headers
    end
  ...
  test "edit returns success" do
    get edit_admin_brand_path(brands(:ambrosoli)), headers: admin_headers
    assert_response :success
  end
  ...
  test "destroy brand without candies succeeds" do
    ...
    assert_difference("Brand.count", -1) do
      delete admin_brand_path(brand), headers: admin_headers
    end
    assert_redirected_to admin_brands_path
  ...
  test "destroy brand with candies fails and shows alert" do
    assert_no_difference("Brand.count") do
      delete admin_brand_path(brands(:costa)), headers: admin_headers
    end
    assert_redirected_to admin_brands_path
